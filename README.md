...
Заміни `theme.json`, `chrome.css`, `LetterTabs.uc.js`, `README.md` у корені репозиторію. У Sine перевір оновлення, після чого повністю перезапусти Zen. У списку модів має бути версія **1.3.0**. Для цього мода Sine має дозволяти JavaScript з неофіційних джерел.
