...
Заміни `theme.json`, `chrome.css`, `LetterTabs.uc.js`, `README.md` у корені репозиторію. У Sine перевір оновлення, після чого повністю перезапусти Zen. У списку модів має бути версія **1.2.3**. Для цього мода Sine має дозволяти JavaScript з неофіційних джерел.
